...
class EventCaptureActivity :
    ...
    private fun setUpViewPagerAdapter() {
        ...
        adapter = getAdapter(intent.getIntExtra(BIOMETRICS_VERIFICATION_STATUS, -1))
    ...
    private fun getAdapter(verificationStatus: Int): EventCapturePagerAdapter {
    ...
    companion object {
        ...
        @JvmStatic
        fun getActivityBundleWithBiometrics(
            eventUid: String,
            programUid: String,
            eventMode: EventMode,
            guid: String?,
