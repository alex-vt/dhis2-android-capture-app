...
class EventCapturePresenterImpl(
    ...
    override fun setValueChanged(uid: String) {}

    override fun getBiometricsAttributeValueInTeiLastUpdated(deUid: String?): Date? {
        return eventCaptureRepository.biometricsAttributeValueInTeiLastUpdated
    }

    override fun updateBiometricsAttributeValueInTei(biometricsGuid: String?) {
