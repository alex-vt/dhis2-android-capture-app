    ...
    public FieldUiModel create(@NonNull String id,
        ...
        if (BIOMETRICS_ENABLED){
            if(isBiometricText(label)){
                return BiometricsViewModel.create(id,R.layout.form_biometrics, label, mandatory, value, section,editable, description, objectStyle, style, url);
            }

            if(isBiometricsVerificationText(label)){
                return BiometricsVerificationViewModel.create(id, R.layout.form_biometrics_verification, label, mandatory, value, section,editable, description, objectStyle, style, url, BiometricsVerificationView.BiometricsVerificationStatus.NOT_DONE);
            }
        }
